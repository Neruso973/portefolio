        ...
        <div className="flex place-content-around mt-7">
          ...
          <div className="flex flex-col">
            <div className="flex mt-6">
              <ul className="text-2xl text-[#1B2271] ml-7 mr-7">
              ...
              <ul className="text-[#1B2271] text-2xl">
                <li className="flex space-x-3 mt-4">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6"
            ...
            <div className="w-46/12 h-[18rem] mt-5 p-3 rounded-3xl">
              <p className="text-white p-4 text-xl">
                Etudiant à la recherche d'une alternance en contrat
                d'apprentissage dans le développement web. Intéressé depuis tout
                petit par l’informatique, j’ai commencé à acquérir mon
                expérience coté Hardware, via le montage et la maintenance de
                nombreux PC et smartphone, puis je me suis tourné naturellement
                vers le développement web. Tout d'abord en autodidacte, avant de
                suivre une formation proffetionalisante. Avec pour objectif
                d'acquerir de l'experience et de m'ouvrir a de nouveaux langages
                et technos.
              </p>
            </div>
          </div>
